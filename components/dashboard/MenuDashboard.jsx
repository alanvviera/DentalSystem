                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center justify-start">
                            ...
                            <a href="https://flowbite.com" className="flex ml-2 md:mr-24">
                                <img src={"/icon.png"} className="h-8 mr-3" alt="Logo dentista" />
                                <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-black">Dentista</span>
                            </a>
                        </div>
