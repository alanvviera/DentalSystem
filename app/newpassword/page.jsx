          ...
          <section className="flex flex-col justify-center min-h-[100vh] bg-secondary lg:bg-transparent">
            ...
            <article className="relative  w-full lg:max-w-[30vw] lg:min-h-min lg:rounded-2xl  overflow-hidden m-auto lg:bg-secondary">
                ...
                >
                    ...
                    <section className="overflow-hidden bg-[#fff] w-[100%] mx-4 my-2 border-none rounded-lg outline-0">
                        ...
                        {/* inputs */}
                          <div className="relative grid grid-cols-1">
                            <input
                                className="outline-0 py-2 px-[15px] w-[100%] h-[40px] font-extralight 
                                border-b border-solid border-[#8080804c] bg-[#fff] pr-10 peer"
                          ...
                          <div className="relative grid grid-cols-1">
                              <input
                                className="outline-0 py-2 px-[15px] w-[100%] h-[40px] font-extralight border-b border-solid 
                                border-[#8080804c] bg-[#fff] pr-10 peer"
                    ...
                    <button className="bg-primary text-white w-full h-10 pt-2 pb-2 border-0 overflow-hidden rounded-3xl text-base 
                    font-semibold cursor-pointer transition-all ease-in-out duration-1000 hover:bg-[#005ce6] 
