...
const EditAppointmentPage = async ({ params }) => {
    ...
    return (
        <main style={{ margin: "20px" }}>
            ...
            <Flex justify={"space-between"}>
                <Button px={0} component="a" leftSection={<ArrowLeftOutlined />} variant="subtle" href={`/employee-menu/clinics/${clinicId}/appointments`} >
                    Volver a citas
                </Button>
            ...
            />
            <Button variant="default" component="a" href={`/employee-menu/clinics/${clinicId}/appointments/`} fullWidth mt={10}>
                Cancelar
            </Button>
        </main>
    );
