    ...
    return (
        <main style={{ margin: "20px" }}>
            ...
            <Group justify='space-between'>
                <Title>Citas</Title>
                <Button leftSection={<PlusOutlined />} component='a' href={`/employee-menu/clinics/${clinicId}/appointments/create`}>
                    Agregar
                </Button>
            </Group>
            <VisualizeData
                    ...
                    <>
                        {
                            listEmployeesExample.map((dataEmployee) => {
                                return (<LabelDataText  key={dataEmployee.idClient} subTileIcon={<>
                                    ...
                                    <Title style={{ cursor: 'pointer' }} onClick={() => router.push(`/employee-menu/clinics/${clinicId}/appointments/${dataEmployee.idClient}`)} order={6} >Editar cita</Title>
                                } />
                                )
